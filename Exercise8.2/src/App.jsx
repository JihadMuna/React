...
const data = [
  ...
  {
  name: 'Donatello',
  img:'https://a1cf74336522e87f135f-2f21ace9a6cf0052456644b80fa06d4f.ssl.cf2.rackcdn.com/images/characters/large/800/Donatello.Teenage-Mutant-Ninja-Turtles.webp',pizzaToppings: [
  {
  name: 'Extra Cheese',
    ...
    return (
      <div className="app">
        {data.map((turtle, index) => (
          <TurtleCard key={index} {...turtle} onAddTopping={handleAddTopping} />
        ))}
        <ToppingsList toppings={selectedToppings} />
      </div>
    );
  };
